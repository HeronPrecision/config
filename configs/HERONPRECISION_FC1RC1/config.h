...
#define BOARD_NAME        HERONPRECISION_FC1RC1
...
#define USE_MAX7456
#define MAX_SUPPORTED_MOTORS 8 //experimental
...
#define GYRO_1_EXTI_PIN      PB1 //might not work
#define GYRO_2_EXTI_PIN      PB0 //might not work
